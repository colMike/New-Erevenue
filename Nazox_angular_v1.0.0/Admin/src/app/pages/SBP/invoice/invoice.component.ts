...
/*    this.reportSvc.printInvoice(111,'frank',0)
    ...
    this.reportUrl = `http://localhost:8080/revenueCollection/api/erevenue/reports?type=I&businnessNo=${this.businessNo}&approvedUser=${this.approvedUser}&appliedFor=${this.appliedFor}`;
  }
  getsubCountys(){
    //  this.blockUI.start("Loading data....");
